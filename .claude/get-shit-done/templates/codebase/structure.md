...
- Usage: Reference from command with `@/home/anti-duhring/alt/pocs/agent-db/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/anti-duhring/alt/pocs/agent-db/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/anti-duhring/alt/pocs/agent-db/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
