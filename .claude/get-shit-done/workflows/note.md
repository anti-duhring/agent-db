...
- **Global scope**: `/home/anti-duhring/alt/pocs/agent-db/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/anti-duhring/alt/pocs/agent-db/.claude/notes/`)
...
2. Glob `/home/anti-duhring/alt/pocs/agent-db/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/anti-duhring/alt/pocs/agent-db/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/anti-duhring/alt/pocs/agent-db/.claude/notes/` — works in any directory
