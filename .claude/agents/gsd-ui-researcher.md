...
Use template from `/home/anti-duhring/alt/pocs/agent-db/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/anti-duhring/alt/pocs/agent-db/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/anti-duhring/alt/pocs/agent-db/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
