...
Reference full template: `/home/anti-duhring/alt/pocs/agent-db/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/anti-duhring/alt/pocs/agent-db/.claude/get-shit-done/templates/state.md`.
